...
import ResumeSingleColumn from './resume-single-column';
import ResumeTwoColumn from './resume-two-column';
import ResumeModern from './resume-modern';
import ResumeModernTwoColumn from './resume-modern-two-column';
import {
  type TemplateSettings,
  type TemplateType,
  DEFAULT_TEMPLATE_SETTINGS,
  settingsToCssVars,
} from '@/lib/resume-matcher/template-settings';
